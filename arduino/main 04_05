...
////       Set up pins used for rows and columns     |  |  |  |
 ...
 const int col1 = 9;                            //   |  |  |  |
 const int col2 = 10;                           //  _______________ R3
...
//-----------------------------------------------------------------------------------------------------------------------
  ...
  //------------------------------------------------------------------------------------------------------------------------
    ...
    change = compare(tempArray0, tempArray1);   // Compare the last 2 stored temporary arrays
      ...
      if(change){                              // If there is a change then copy the last array into a global array and returns
...
bool compare(int (*A0)[4], int (*A1)[4] ){  //compares arrays and returns true if there is a change
  int count = 0;
